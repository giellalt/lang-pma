...
do
 ...
 do
#   echo "${lemma}${form}" | $LOOKUP $GTLANGS/lang-pma/src/fst/generator-gt-norm.xfst # xfst
    echo "${form}${lemma}+V" | $HLOOKUP $GTLANGS/lang-pma/src/fst/generator-gt-norm.hfstol # hfst
 done
 rm -f $L_FILE
done
